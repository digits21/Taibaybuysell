 <?php
                                      include("connect.php");
                                        $i=1;
$req=$pdo->query('SELECT users.username,users.email,users.city,users.phone,users.link,users.city,users.date,bikes.title,bikes.description,bikes.image,bikes.price FROM users, bikes WHERE users.id=bikes.user_id ORDER BY bikes.price LIMIT 9');
