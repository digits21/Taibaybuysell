 <?php
                                      include("connect.php");
                                        $i=1;
$req=$pdo->query('SELECT users.username,users.email,users.city,users.phone,users.link,users.city,users.date,cars.title,cars.description,cars.image,cars.price FROM users, cars WHERE users.id=cars.user_id ORDER BY users.date LIMIT 9');
