<?php
                                      ...
                                      include("connect.php");
                                        $i=1;
$req=$pdo->query('SELECT users.username,users.email,users.city,users.phone,users.link,users.city,users.date,electronics.title,electronics.description,electronics.image,electronics.price FROM users, electronics WHERE users.id=electronics.user_id ORDER BY users.date LIMIT 9');
