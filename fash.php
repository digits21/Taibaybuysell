 <?php
                                      include("connect.php");
                                        $i=1;
$req=$pdo->query('SELECT users.username,users.email,users.city,users.phone,users.link,users.city,users.date,fashion.title,fashion.description,fashion.image,fashion.price FROM users, fashion WHERE users.id=fashion.user_id ORDER BY users.date LIMIT 9');
