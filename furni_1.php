<?php
                                      include("connect.php");
                                        $i=1;
$req=$pdo->query('SELECT users.username,users.email,users.city,users.phone,users.link,users.city,users.date,furnitures.title,furnitures.description,furnitures.image,furnitures.price FROM users, furnitures WHERE users.id=furnitures.user_id ORDER BY users.date LIMIT 9');
